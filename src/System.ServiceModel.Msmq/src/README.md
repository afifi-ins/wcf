...
This package takes a transitive dependency on [MSMQ.Messaging](https://www.nuget.org/packages/MSMQ.Messaging), a community port of `System.Messaging` that wraps `mqrt.dll` from the Windows MSMQ feature. Installing `System.ServiceModel.Msmq` brings it in automatically.
...
{
    Label = "order-42",
    Priority = MSMQ.Messaging.MessagePriority.High,
